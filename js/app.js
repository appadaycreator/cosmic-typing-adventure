...
class CosmicTypingApp {
    ...
    getDOMElements() {
        ...
        this.elements.currentPlanetImage = document.getElementById('current-planet-image');
        this.elements.currentPlanetName = document.getElementById('current-planet-name');
        ...
        this.elements.finalAccuracyDisplay = document.getElementById('final-accuracy');
        ...
        this.elements.backToPlanetsFromResultsBtn = document.getElementById('back-to-planets-from-results');
    }
    ...
    setupEventListeners() {
        ...
        this.elements.pauseBtn.addEventListener('click', () => this.pausePractice());
        this.elements.resetBtn.addEventListener('click', () => this.resetPractice());
        this.elements.backToPlanetsBtn.addEventListener('click', () => this.showPlanetSelection());
        
        // Results controls
        this.elements.saveResultBtn.addEventListener('click', () => this.saveResult());
        this.elements.retryPracticeBtn.addEventListener('click', () => this.retryPractice());
        this.elements.backToPlanetsFromResultsBtn.addEventListener('click', () => this.showPlanetSelection());
    ...
    updatePlanetInfo(planet) {
        ...
        if (this.elements.currentPlanetName) {
            this.elements.currentPlanetName.textContent = planetNames[planet] || planet;
        }
    ...
    saveResult() {
        ...
        if (window.CosmicSupabase && window.CosmicSupabase.TypingStats) {
            window.CosmicSupabase.TypingStats.saveSession(sessionData).then(success => {
                if (success) {
    ...
    saveResultsToStorage(results) {
        try {
            const sessions = JSON.parse(localStorage.getItem('cosmic_typing_sessions') || '[]');
            sessions.push({
                ...results,
                planet: this.currentPlanet,
                session_date: new Date().toISOString()
